    ...
    ui(new Ui::normal)
{
    ...
    QPixmap pix1("E:/youtube/project/final/firstSem-master/firstSem-master/typingTutor-master/typingTutor-master/pictures/medium");
...
void normal::keyPressEvent(QKeyEvent *event){
    ...
    if(event->key() == Qt::Key_Control){
       if(start_value == 0){
           ui->lineEdit->clear();
           QFile file("E:/youtube/project/final/firstSem-master/firstSem-master/typingTutor-master/typingTutor-master/data/Medium.txt");
...
void normal::highscore(){
    ...
    QFile file2("E:/youtube/project/final/firstSem-master/firstSem-master/typingTutor-master/typingTutor-master/highscore/medium_highscore.txt");
